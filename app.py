...
from src.services.llm_service import get_summary, get_keypoints, get_qa, get_quiz, get_flashcards, get_visuals
from src.utils.helpers import generate_pdf, truncate_text, generate_chart
...
if submitted:
    ...
    if not url:
        ...
        with st.spinner("Understanding video (captions, then audio, then visuals if needed)..."):
            text, status = get_full_understanding(url, language=selected_lang)
        ...
        if not text:
            ...
            with st.spinner("Generating notes..."):
                from src.services.llm_service import get_all_notes, parse_all_notes
